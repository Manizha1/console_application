...
conn = psycopg2.connect(dbname="python_db", host="localhost", user="postgres", password="123456789", port=5433)
...
def create_task(task):
    ...
    try:
        ...
        print(f"Ошибка во время сохранения задачи в бд: {e}")
        return None
...
def get_all_deleted_tasks(user_id):
    sql_query = """SELECT id, title, description, deadline, priority, is_done, deleted_at
